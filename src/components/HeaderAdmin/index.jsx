    ...
    return(
        ...
        <div className="w-2 surface-200">
            ...
            <nav>
                <ul>
                    <li className={'p-3'}>
                        <Link to={'/dashboard'} className={'flez align-items-center gap-2 text-color hover:text-primary'}>
                            <i className="pi pi-home"></i> Dashboard
                        </Link>
                    </li>
                    <li className={'p-3'}>
                        <Link to={'/dashboard/usuarios'} className={'flez align-items-center gap-2 text-color hover:text-primary'}>
